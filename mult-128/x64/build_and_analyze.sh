...
perf stat -r 10 -o analize_data_x64_asm.txt -e user_time,instructions,cycles ./x64_mult_128

# Build with optimisations
gcc ../main-128.c x64_mul128.o -O3 -o x64_mult_128_o3
perf stat -r 10 -o analize_data_x64_asm_o3.txt -e user_time,instructions,cycles ./x64_mult_128_o3
